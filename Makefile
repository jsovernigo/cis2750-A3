...
#
build: cconverter post libstream.a addAuthor view.py create
	mkdir -p ./messages/
...
addAuthor: libstream.a addAuthor.c
	$(CC) $(CFLAGS) -o $(EXEC2) addAuthor.c -I$(INCLUDE) -L$(LPATH) $(LINK)
...
stream.o: stream.c
	$(CC) $(CFLAGS) -c stream.c -I$(INCLUDE)
...
clobber:
	rm $(EXEC1) $(EXEC2) $(EXEC3) $(CCON) $(COBJECTS) $(OBJECTS) libstream.a post.c
